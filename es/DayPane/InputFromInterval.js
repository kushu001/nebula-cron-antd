...
function InputFromInterval(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, "\u4ECE\xA0", /*#__PURE__*/React.createElement(InputNumber, {
    disabled: disabled,
    min: 1,
    max: 31,
    value: from,
  ...
  }), "\xA0\u65E5\u5F00\u59CB\uFF0C \u6BCF\xA0", /*#__PURE__*/React.createElement(InputNumber, {
    disabled: disabled,
    min: 1,
    max: 31,
    value: interval,
