...
function InputFromInterval(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "\u4ECE\xA0", /*#__PURE__*/_react.default.createElement(_antd.InputNumber, {
    disabled: disabled,
    min: 1,
    max: 31,
    value: from,
  ...
  }), "\xA0\u65E5\u5F00\u59CB\uFF0C \u6BCF\xA0", /*#__PURE__*/_react.default.createElement(_antd.InputNumber, {
    disabled: disabled,
    min: 1,
    max: 31,
    value: interval,
...
var _default = exports.default = InputFromInterval;